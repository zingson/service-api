...
public class CodeGenerator {
    ...
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:oracle:thin:@proxy.unionlive.com:31521:orcl";
    private static final String JDBC_USERNAME = "unionlive";
    private static final String JDBC_PASSWORD = "unionlive";
    private static final String JDBC_DIVER_CLASS_NAME = "oracle.jdbc.OracleDriver";

    private static final String PROJECT_PATH = System.getProperty("user.dir")+"/sp-service-waimai"; //项目在硬盘上的基础路径
    private static final String TEMPLATE_FILE_PATH = PROJECT_PATH + "/src/test/resources/template";//模板位置

    private static final String JAVA_PATH = "/src/main/java"; //java文件路径
    private static final String RESOURCES_PATH = "/src/main/resources";//资源文件路径

    public static final String BASE_PACKAGE = "com.ul.biz.wm";//项目基础包名称，根据自己公司的项目修改

    public static final String MODEL_PACKAGE = BASE_PACKAGE + ".model";//Model所在包
    public static final String MAPPER_PACKAGE = BASE_PACKAGE + ".mapper";//Mapper所在包
    public static final String MAPPERXML_PACKAGE = "mapper.wm";//Mapper所在包
    public static final String SERVICE_PACKAGE = BASE_PACKAGE + ".service";//Service所在包
    public static final String SERVICE_IMPL_PACKAGE = SERVICE_PACKAGE + ".impl";//ServiceImpl所在包
    public static final String CONTROLLER_PACKAGE = BASE_PACKAGE + ".controller";//Controller所在包

    public static final String MAPPER_INTERFACE_REFERENCE = "com.ul.core.common.Mapper";//Mapper插件基础接口的完全限定名

    private static final String PACKAGE_PATH_SERVICE = packageConvertPath(SERVICE_PACKAGE);//生成的Service存放路径
    private static final String PACKAGE_PATH_SERVICE_IMPL = packageConvertPath(SERVICE_IMPL_PACKAGE);//生成的Service实现存放路径
    private static final String PACKAGE_PATH_CONTROLLER = packageConvertPath(CONTROLLER_PACKAGE);//生成的Controller存放路径

    private static final String AUTHOR = "Zing";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

    /*
     * 生成文件会覆盖已经存在的文件，切记备份改动过的代码
     */
    public static void main(String[] args) {
        System.out.println("生成文件项目路径："+PROJECT_PATH );

        genCode("ULTAB_WM_ORDERINFO",
